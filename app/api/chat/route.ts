...
export async function POST(req: Request) {
    try{
        ...
        const embedding = Array.isArray(rawEmbedding[0]) 
            ? (rawEmbedding as number[][])[0]  // Extract first row if 2D
            : (rawEmbedding as number[]);       // Use directly if 1D
        ...
        try {
            ...
            const cursor = collection.find(null, {
                sort: {
                    $vector: embedding, // Corrected extraction
                },
                limit: 10,
            });
        ...
        const template = {
            ...
            content: `You are an AI assistant who knows everything about Formula One.
                    ...
                    just send ans not your thinking process
